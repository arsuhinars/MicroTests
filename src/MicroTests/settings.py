...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'MicroTestsApp/templates')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MicroTests.wsgi.application'
...
# Authorization
AUTH_USER_MODEL = 'MicroTestsApp.User'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'MicroTestsApp/static')
]
